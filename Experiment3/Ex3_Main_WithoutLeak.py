...
Experiment3: train and test model with data that has no leakage (Leakage-Free Data)
...
gen_dir = 'D:/First Project/Codes/Experiments/Ex3/data/case3/Noleakage/'  # case1: No Leakage
...
Exdir = 'D:/First Project/Codes/Experiments/Ex3/data/case3/Ex_test' 
...
model_save_path = 'D:/First Project/Codes/Experiments/Ex3/results/best_model_NoLeak.h5'
...
y_yhat_filename = 'D:/First Project/Codes/Experiments/Ex3/results/y_yhat_NoLeak.xlsx'
...
excel_filename = 'D:/First Project/Codes/Experiments/Ex3/results/NoLeak_results.xlsx'
...
plt.title('DSC plot for no leak', fontsize = 18)
...
image_name = 'D:/First Project/Codes/Experiments/Ex3/results/dsc_curve_NoLeak.svg'
...
filename = 'D:/First Project/Codes/Experiments/Ex3/results/DSC_scores_NoLeak.xlsx'
...
plt.title('Loss plot for n o leak', fontsize = 18)
...
image_name = 'D:/First Project/Codes/Experiments/Ex3/results/Loss_NoLeak.svg'
plt.savefig(image_name, format='svg')
...
filename = 'D:/First Project/Codes/Experiments/Ex3/results/Loss_NoLeak.xlsx'
df.to_excel(filename, index=False)  
