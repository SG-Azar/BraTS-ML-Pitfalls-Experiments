...
Experiment3: train and test model with data that has leakage (Single-Leakage Data & Dual-Leakage Data)
...
def dice_metric_batch(y_true, y_pred, smooth=0.01):      
...
def dice_metric_single(y_true, y_pred, smooth=0.01):       
...
gen_dir = 'D:/First Project/Codes/Experiments/Ex3/data/case4/Leakage/'  # case1: with Leakage
...
Exdir = 'D:/First Project/Codes/Experiments/Ex3/data/case4/Ex_test' 


gen_test_a = DataGenerator(data_path = gen_dir+ 'Test',
                    arrays=array_labels,
                    batch_size=batch_size)

gen_test_b = DataGenerator(data_path = Exdir,
                    arrays=array_labels,
                    batch_size=batch_size)
...
model_save_path = 'D:/First Project/Codes/Experiments/Ex3/results/best_model_Leak.h5'
...
y_yhat_filename = 'D:/First Project/Codes/Experiments/Ex3/results/y_yhat_Leak.xlsx'
...
excel_filename = 'D:/First Project/Codes/Experiments/Ex3/results/Leak_results.xlsx'
...
plt.title('DSC plot for with leakage', fontsize = 18)
...
image_name = 'D:/First Project/Codes/Experiments/Ex3/results/dsc_curve_Leak.svg'
...
filename = 'D:/First Project/Codes/Experiments/Ex3/results/DSC_scores_Leak.xlsx'
...
plt.title('Loss plot for with leakage', fontsize = 18)
...
image_name = 'D:/First Project/Codes/Experiments/Ex3/results/Loss_Leak.svg'
plt.savefig(image_name, format='svg')
...
filename = 'D:/First Project/Codes/Experiments/Ex3/results/Loss_Leak.xlsx'
df.to_excel(filename, index=False)  
