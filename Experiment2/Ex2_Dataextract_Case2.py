...
This code extracts data for Case2 in Experiment 2:


siteinfo is the only confounder
...
save_dir = 'D:/First Project/Codes/Experiments/Ex2/data/data2-clean-small-siteinfo/'
